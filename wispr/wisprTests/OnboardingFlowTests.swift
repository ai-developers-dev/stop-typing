...
struct OnboardingFlowAccessibilityTests {
    ...
    func testStepAccessibilityLabels() {
        ...
        let expectedLabels: [OnboardingStep: String] = [
            .welcome: "Welcome to Stop Typing. Dictate text anywhere on your Mac. All transcription happens on-device.",
            ...
            .completion: "Setup complete. Stop Typing is ready. Press Option Space to start dictating.",
        ]
