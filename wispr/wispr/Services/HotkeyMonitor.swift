...
final class HotkeyMonitor {
    ...
    private func setupFnEventTap() throws {
        // CGEventTap requires Accessibility permission to intercept system events.
        // Check upfront so we can give a clear error instead of a generic nil from tapCreate.
        guard AXIsProcessTrusted() else {
            Log.hotkey.error("setupFnEventTap — Accessibility permission not granted")
            throw WisprError.accessibilityPermissionDenied
        }
